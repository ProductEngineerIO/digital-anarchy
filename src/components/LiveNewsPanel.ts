...
export const OPTIONAL_LIVE_CHANNELS: LiveChannel[] = [
  ...
  { id: 'abc-news', name: 'ABC News', handle: '@ABCNews', fallbackVideoId: 'W1Blk0qdJBY' },
  ...
  { id: 'livenow-fox', name: 'LiveNOW from Fox', handle: '@LiveNOWfox', fallbackVideoId: '5TNVS5FGlpU' },
  ...
  { id: 'rt', name: 'RT', handle: '', fallbackVideoId: 'GrRDLiKS6XY' },
  ...
  { id: 'record-news', name: 'Record News', handle: '@RecordNews', fallbackVideoId: 'K4Y4cB_J3kE' },
  ...
  { id: 'wion', name: 'WION', handle: '@WION', fallbackVideoId: 'vCqAKHEMWsk' },
  ...
  { id: 'arirang-news', name: 'Arirang News', handle: '@ArirangCoKrArirangNEWS', fallbackVideoId: 'kbI1n4SMHX4' },
  { id: 'india-today', name: 'India Today', handle: '@indiatoday', fallbackVideoId: 'sYZtOFzM78M' },
  { id: 'abp-news', name: 'ABP News', handle: '@ABPNews', fallbackVideoId: 'OjnFLFLiCdE' },
  ...
  { id: 'sabc-news', name: 'SABC News', handle: '@SABCDigitalNews', fallbackVideoId: 'fJpDxLQ3BTI' },
  ...
  { id: 'tv5monde-info', name: 'TV5 Monde Info', handle: '@TV5MONDEInfo', fallbackVideoId: '8MZPiCsZmvI' },
  { id: 'nrk1', name: 'NRK1', handle: '@nrk', fallbackVideoId: 'e4CKYEfcZ8A' },
  { id: 'aljazeera-balkans', name: 'Al Jazeera Balkans', handle: '@AlJazeeraBalkans', fallbackVideoId: 'ZJ_jIB3Qfh4' },
  // Oceania
